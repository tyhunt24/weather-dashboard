function displayWeather(event) {
    ...
    $.ajax({
        ...
        // ! need to set the local storage for each item
        // var cities = $("#searchInput").val()
        // citiesSearched.push(cities)
        // localStorage.setItem("searchHistory", JSON.stringify(citiesSearched))
        // var citiesSearched = localStorage.getItem('searchHistory') ? JSON.parse(localStorage.getItem("searchHistory")) : [];

        $("#firstDisplay").addClass("hide")
    })
}
